...
def color_scale_for_mode(mode: str):
    # The first color represents the lowest bin (0–2). It is intentionally
    # NOT white, so low-count states remain visible in every gradient.
    gradients = {
        "Red → Yellow": [
            [0.00, "#FFF7D6"],  # lightest yellow
            [0.02, "#FFF7D6"],
            [0.03, "#FFD07A"],
            [0.45, "#FFD07A"],
            [0.46, "#F89C3D"],
        ...
        "Blue → Cyan": [
            [0.00, "#E6F7FF"],  # lightest blue/cyan
            [0.02, "#E6F7FF"],
            [0.03, "#CFEFFF"],
            [0.45, "#7FD3FF"],
            [0.46, "#2B8CFF"],
        ...
        "Purple → Pink": [
            [0.00, "#F8EAFE"],  # lightest purple/pink
            [0.02, "#F8EAFE"],
            [0.03, "#F3D9FF"],
            [0.45, "#D8A8FF"],
            [0.46, "#B05CFF"],
